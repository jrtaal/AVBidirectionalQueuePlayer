Pod::Spec.new do |spec|
  ...
  spec.summary      = <<-EOF
This is a basic library to extend AVQueuePlayer to provide the ability to play previous items (IE move backwards in the queue).
EOF
...
EOF
  spec.source       = { :git => 'https://github.com/jrtaal/AVQueuePlayerPrevious.git', :tag => '1.0.2' }
